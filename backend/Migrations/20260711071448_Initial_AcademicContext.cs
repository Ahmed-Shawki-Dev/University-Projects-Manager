...
{
    /// <inheritdoc />
    public partial class Initial_AcademicContext : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AcademicContexts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AcademicContexts_Faculties_FacultyId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalProjectGrade = table.Column<decimal>(type: "numeric(5,2)", nullable: false),
                    Type = table.Column<int>(type: "integer", nullable: false),
                    FacultyId = table.Column<Guid>(type: "uuid", nullable: false),
                    AcademicContextId = table.Column<Guid>(type: "uuid", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StudentGrades", x => new { x.StudentId, x.MilestoneId });
                    table.ForeignKey(
                        name: "FK_StudentGrades_Milestones_MilestoneId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AcademicContexts_FacultyId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Projects_AcademicContextId",
                table: "Projects",
                column: "AcademicContextId");

            migrationBuilder.CreateIndex(
                name: "IX_Projects_FacultyId_Slug",
                table: "Projects",
                columns: new[] { "FacultyId", "Slug" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_StudentGrades_MilestoneId",
                table: "StudentGrades",
                column: "MilestoneId");
